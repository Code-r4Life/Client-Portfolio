    ...
    <div className='custom-scrollbar flex-1 overflow-y-auto flex flex-col h-screen'>
      ...
      <div className="pt-[100px] max-w-6xl mx-auto p-6 text-gray-900">
        ...
        <div className="space-y-10">
          ...
          {/* Beyond the Lab */}
          <section className="cursor-pointer relative group bg-white shadow-lg rounded-xl p-8 transition-all duration-300 hover:shadow-2xl hover:scale-105 border border-gray-200 hover:border-blue-300 mb-10">
